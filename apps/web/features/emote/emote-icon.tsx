...
function glyph(id: EmoteId): React.ReactNode {
  switch (id) {
    ...
    case 'heart':
      return (
        <path d="M12 20.3l-1.5-1.37C5.4 14.3 2.5 11.6 2.5 8.1 2.5 5.3 4.7 3 7.5 3c1.7 0 3.3.8 4.5 2.1C13.2 3.8 14.8 3 16.5 3 19.3 3 21.5 5.3 21.5 8.1c0 3.5-2.9 6.2-8 10.83L12 20.3z" />
      );
    case 'like':
      return (
        <>
          <path d="M7 11v9.5H4.2a1.2 1.2 0 0 1-1.2-1.2v-7.1a1.2 1.2 0 0 1 1.2-1.2H7z" />
          <path d="M7 11l3.7-7.2a1.7 1.7 0 0 1 3.2 1l-.7 3.9h4.9a1.9 1.9 0 0 1 1.87 2.27l-1.1 6a1.9 1.9 0 0 1-1.87 1.53H7" />
        </>
      );
    case 'cry':
      return (
        <>
          ...
          <path d="M8.8 12c-.9 1.3-1.5 2.3-1.5 3a1.5 1.5 0 0 0 3 0c0-.7-.6-1.7-1.5-3z" />
        </>
      );
    case 'clap':
