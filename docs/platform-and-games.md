...
| **Outcome** | Terminal match result: `Win` (with winner + winning-line coordinates), `Draw`, `Resign`, `Timeout`, or `Disconnect` (the still-connected player claimed victory after the §1 #7 reconnect grace elapsed). |
