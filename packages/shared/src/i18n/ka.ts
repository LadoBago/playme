...
export const ka: Record<EnKey, string> = {
  ...
  'copyright.body':
    'PlayMe.ge არის უფასო, ანონიმური პლატფორმა მეგობართან ონლაინ სათამაშოდ — რეგისტრაციის გარეშე, უბრალოდ გაუზიარე ბმული. სახელწოდება PlayMe.ge, ლოგო, საიტის დიზაინი და კოდი დაცულია საავტორო უფლებებით. აქ შემოთავაზებული კლასიკური თამაშები (ჯვარ-ნული, Connect 4, რევერსი) საზოგადო საკუთრებაა; დაცულია მხოლოდ ამ საიტის რეალიზაცია და წარმოდგენა.',
