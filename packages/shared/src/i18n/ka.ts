...
export const ka: Record<EnKey, string> = {
  ...
  'copyright.body':
    'PlayMe.ge არის უფასო, ანონიმური პლატფორმა მეგობართან ონლაინ სათამაშოდ — რეგისტრაციის გარეშე, უბრალოდ გააზიარე ბმული. სახელწოდება PlayMe.ge, ლოგო, საიტის დიზაინი და კოდი დაცულია საავტორო უფლებებით. აქ შემოთავაზებული კლასიკური თამაშები (ჯვარ-ნული, Connect 4, რევერსი) საზოგადო საკუთრებაა; დაცულია მხოლოდ ამ საიტის რეალიზაცია და წარმოდგენა.',
  ...
  'about.intro':
    'PlayMe.ge პირადი პროექტია, პლატფორმა, მეგობართან ონლაინ სათამაშოდ — რეგისტრაციის გარეშე, უბრალოდ გააზიარე ბმული და ითამაშე სხვადასხვა ინტელექტუალური თამაშები.',
