...
export const ka: Record<EnKey, string> = {
  ...
  'games.tictactoe-3x3.rules':
    'მოთამაშეები რიგრიგობით სვამენ X-ს ან O-ს 3×3 დაფაზე. ვინც პირველი დააწყობს სამ ერთსა და იმავე ნიშანს ჰორიზონტალურად, ვერტიკალურად ან დიაგონალზე — იგებს. თუ დაფა შეივსება გამარჯვებული მწკრივის გარეშე — ფრე. პირველი სვლა ყოველთვის X-ს ეკუთვნის.',
  ...
  'games.tictactoe-6x6.rules':
    'მოთამაშეები რიგრიგობით სვამენ X-ს ან O-ს 6×6 დაფაზე. ვინც პირველი დააწყობს მინიმუმ ოთხ ერთსა და იმავე ნიშანს ჰორიზონტალურად, ვერტიკალურად ან დიაგონალზე — იგებს; ხუთი ან ექვსი ერთად დაწყობაც გამარჯვებაა. თუ დაფა შეივსება გამარჯვებული ხაზის გარეშე — ფრე. პირველი სვლა ყოველთვის X-ს ეკუთვნის.',
  'games.tictactoe-9x9.name': 'ჯვარედინა 9×9',
  'games.tictactoe-9x9.shortDescription':
    'ხუთის გასწორება 9×9 დაფაზე. ჩაწერე X ან O; პირველი, ვინც სულ მცირე ხუთს დააწყობს — იგებს.',
  'games.tictactoe-9x9.rules':
    'მოთამაშეები რიგრიგობით სვამენ X-ს ან O-ს 9×9 დაფაზე. ვინც პირველი დააწყობს სულ მცირე ხუთ ერთსა და იმავე ნიშანს ზედიზედ — ჰორიზონტალურად, ვერტიკალურად ან დიაგონალზე — იგებს. უფრო გრძელი მწკრივიც (ექვსი, შვიდი, რვა ან ცხრა ზედიზედ) ერთ მოგებად ითვლება. თუ დაფა შეივსება გამარჯვებული მწკრივის გარეშე — ფრე. პირველი სვლა ყოველთვის X-ს ეკუთვნის.',
