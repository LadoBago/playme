...
export const ka: Record<EnKey, string> = {
  // --- Site chrome ---
  // იხ. en.ts: საკვანძო ფრაზა წინ, ბრენდი ბოლოს (SERP-ში ჩამოჭრას უძლებს).
  'site.title': 'ითამაშე ონლაინ მეგობართან, რეგისტრაციის გარეშე — PlayMe',
  ...
  'site.homeMetaDescription':
    'ითამაშე ონლაინ სამაგიდო, ინტელექტუალური თამაშები ორ კაცში — მეგობართან, რეგისტრაციის გარეშე. აირჩიე თამაში და გაუზიარე ბმული. თამაში უფასოა.',
  ...
  'site.howItWorks.step2.title': 'გაუზიარე ბმული',
  ...
  'site.howItWorks.step3.body':
    'პირველი მეგობარი, რომელიც ბმულს გახსნის, შემოგიერთდება. ითამაშეთ რიგრიგობით.',
  ...
  'copyright.body':
    'PlayMe.ge არის უფასო, ანონიმური პლატფორმა მეგობართან ონლაინ სათამაშოდ — რეგისტრაციის გარეშე, უბრალოდ გაუზიარე ბმული. სახელწოდება PlayMe.ge, ლოგო, საიტის დიზაინი და კოდი დაცულია საავტორო უფლებებით. აქ შემოთავაზებული კლასიკური თამაშები (იქსიკი და ნოლიკი, Connect 4, რევერსი, ჩაძირობანა) საზოგადო საკუთრებაა; დაცულია მხოლოდ ამ საიტის რეალიზაცია და წარმოდგენა.',
  ...
  'about.intro':
    'PlayMe.ge პირადი პროექტია, პლატფორმა, მეგობართან ონლაინ სათამაშოდ — რეგისტრაციის გარეშე, უბრალოდ გაუზიარე ბმული და ითამაშე სხვადასხვა ინტელექტუალური თამაშები.',
  'about.why.label': 'რისთვის შევქმენი',
  'about.why.body':
    'ხელოვნური ინტელექტის შესაძლებლობების შესასწავლად და გასართობად. არა აბსტრაქტული მაგალითებით, არამედ რეალური პროდუქტის შექმნის გზით.',
  'about.how.label': 'როგორ შევქმენი',
  'about.how.body':
    'ხელოვნური ინტელექტის დახმარებით, თავიდან ბოლომდე. გამოვიყენე Claude Code.',
  'about.stack.label': 'როგორ მუშაობს',
  'about.stack.body':
  ...
  // პირველადი სახელი „იქსიკი და ნოლიკი" (= <h1>); „ჯვარ-ნული" სინონიმად რჩება ძიებისთვის.
  'games.tictactoe.metaTitle': 'იქსიკი და ნოლიკი ონლაინ — ჯვარ-ნული / Tic Tac Toe | PlayMe',
  'games.tictactoe.metaDescription':
    'ითამაშე იქსიკი და ნოლიკი (ჯვარ-ნული, X და 0) ონლაინ მეგობართან — 3×3, 6×6 ან 9×9 დაფაზე. რეგისტრაცია არ გჭირდება.',
  ...
  // ქართული სახელი არ აქვს — ვტოვებთ ლათინურად, როგორც ინგლისურში.
  // „ოთხი ზედიზედ" აღწერით ფრაზად რჩება ძიებისთვის (და metaDescription-ში).
  'games.connect4.name': 'Connect 4',
  'games.connect4.metaTitle': 'Connect 4 ონლაინ — ოთხი ზედიზედ | PlayMe',
  ...
  'join.shareLink.label': 'გაუზიარე ეს ბმული',
  ...
  'match.emote.open': 'გააგზავნე ემოცია',
  'match.emote.tray': 'ემოციები',
  ...
  'match.leaveSetup.confirm.title': 'ნამდვილად გსურთ ოთახიდან გასვლა?',
  'match.leaveSetup.confirm.body': 'გაზიარებული ბმულით კვლავ შეძლებ უკან დაბრუნებას.',
  'match.leaveSetup.confirm.yes': 'გასვლა',
  'match.leaveSetup.confirm.cancel': 'გაუქმება',
  ...
  'games.seabattle.metaTitle': 'ჩაძირობანა (საზღვაო ბრძოლა) ონლაინ — Sea Battle | PlayMe',
  'games.seabattle.metaDescription':
    'ითამაშე ჩაძირობანა ონლაინ მეგობართან — ფარულად განალაგე საკუთარი ფლოტი, ისროლე და ჩაძირე მოწინააღმდეგის ყველა გემი. რეგისტრაციის გარეშე, უბრალოდ გაუზიარე ბმული.',
  'games.seabattle.shortDescription':
    'ფარულად განალაგე ათი გემი და მორიგეობით ისროლეთ. მოხვედრა დამატებით გასროლას გაძლევს. ვინც პირველი ჩაძირავს მოწინააღმდეგის მთელ ფლოტს, ის მოიგებს.',
  'games.seabattle.rules':
    'თითოეული მოთამაშე ფარულად ალაგებს ათ სხვადასხვა ზომის გემს საკუთარ 10×10 ბადეზე: ერთი ცალი ოთხუჯრიანი, ორი — სამუჯრიანი, სამი — ორუჯრიანი და ოთხი — ერთუჯრიანი. გემები სწორი ხაზებია და ერთმანეთს ვერ შეეხებიან (ვერც დიაგონალზე). შემდეგ მოთამაშეები მორიგეობით ისვრიან მოწინააღმდეგის ბადეზე; ყოველი გასროლის პასუხად შეიძლება მიიღოთ: ასცდა, მოხვდა ან ჩაიძირა. მოხვედრა ან ჩაძირვა დამატებითი გასროლის უფლებას გაძლევს. ისვრი იქამდე, სანამ არ ააცილებ. ერთსა და იმავე უჯრაზე ორჯერ სროლა არ შეიძლება. იგებს ის, ვინც პირველი ჩაძირავს მოწინააღმდეგის მთელ ფლოტს. ფრე შეუძლებელია.',
  'games.seabattle.sideFirst': 'მე დავიწყებ',
  'games.seabattle.sideSecond': 'მოწინააღმდეგემ დაიწყოს',
  ...
  'games.seabattle.feedback.hit': 'მოხვდა! კიდევ ისროლე!',
  'games.seabattle.feedback.sunk': 'ჩაიძირა! კიდევ ისროლე!',
  'games.seabattle.feedback.miss': 'ასცდა…',
  ...
  'errors.emote.unknown': 'ეს ემოცია მიუწვდომელია.',
};
