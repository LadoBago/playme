...
export const ka: Record<EnKey, string> = {
  ...
  'games.seabattle.metaDescription':
    'ითამაშე ჩაძირობანა ონლაინ მეგობართან — მალულად განალაგე საკუთარი ფლოტი, ისროლე და ჩაძირე მოწინააღმდეგის ყველა გემი. რეგისტრაციის გარეშე, უბრალოდ გაუზიარე ბმული.',
